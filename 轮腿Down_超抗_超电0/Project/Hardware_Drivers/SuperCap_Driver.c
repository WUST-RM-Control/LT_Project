...
{
    /*===| 如果没有裁判系统数据，则强制关断输出 |===*/
    if(Robo_State.chassis_power_limit == 0) SuperCap_Control_Data_Struct.Enable_Flag = 0; 
    else SuperCap_Control_Data_Struct.Enable_Flag = RoboControl_Struct.SuperCap_State; 
