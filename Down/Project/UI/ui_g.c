...
void _ui_init_g_Dynamic_0() {
    ...
    ui_g_Dynamic_Right_down_Leg->end_y = 742;
...
ui_interface_arc_t *ui_g_Dynamic_Fric_R = (ui_interface_arc_t*)&(ui_g_Dynamic_1.data[3]);
ui_interface_arc_t *ui_g_Dynamic_Fric_L = (ui_interface_arc_t*)&(ui_g_Dynamic_1.data[4]);
...
ui_interface_string_t* ui_g_Dynamic_Yaw_OFFNUM = &(ui_g_Dynamic_2.option);
...
ui_interface_string_t* ui_g_Dynamic_PITCH_OFFNUM = &(ui_g_Dynamic_3.option);
...
ui_interface_string_t* ui_g_Dynamic_Aim_State_NF = &(ui_g_Dynamic_4.option);

void _ui_init_g_Dynamic_4() {
    ui_g_Dynamic_4.option.figure_name[0] = 0;
    ui_g_Dynamic_4.option.figure_name[1] = 0;
    ui_g_Dynamic_4.option.figure_name[2] = 16;
...
ui_interface_string_t* ui_g_Dynamic_Shoot_State = &(ui_g_Dynamic_5.option);

void _ui_init_g_Dynamic_5() {
    ui_g_Dynamic_5.option.figure_name[0] = 0;
    ui_g_Dynamic_5.option.figure_name[1] = 0;
    ui_g_Dynamic_5.option.figure_name[2] = 17;
...
ui_interface_string_t* ui_g_Dynamic_Chassis_State = &(ui_g_Dynamic_6.option);

void _ui_init_g_Dynamic_6() {
    ui_g_Dynamic_6.option.figure_name[0] = 0;
    ui_g_Dynamic_6.option.figure_name[1] = 0;
    ui_g_Dynamic_6.option.figure_name[2] = 18;
...
void _ui_init_g_Static_2() {
    ...
    ui_g_Static_CoastLine1->end_y = 526;
    ...
    ui_g_Static_CoastLine2->end_y = 526;
...
ui_interface_string_t* ui_g_Static_PITCH_OFFSET = &(ui_g_Static_3.option);

void _ui_init_g_Static_3() {
    ui_g_Static_3.option.figure_name[0] = 0;
    ui_g_Static_3.option.figure_name[1] = 1;
    ui_g_Static_3.option.figure_name[2] = 20;
    ui_g_Static_3.option.operate_type = 1;

    ui_g_Static_PITCH_OFFSET->figure_type = 7;
    ui_g_Static_PITCH_OFFSET->operate_type = 1;
    ui_g_Static_PITCH_OFFSET->layer = 0;
    ui_g_Static_PITCH_OFFSET->color = 8;
    ui_g_Static_PITCH_OFFSET->start_x = 242;
    ui_g_Static_PITCH_OFFSET->start_y = 573;
    ui_g_Static_PITCH_OFFSET->width = 2;
    ui_g_Static_PITCH_OFFSET->font_size = 20;
    ui_g_Static_PITCH_OFFSET->str_length = 6;
    strcpy(ui_g_Static_PITCH_OFFSET->string, "PITCH:");
...
void _ui_init_g_Static_4() {
    ...
    ui_g_Static_4.option.figure_name[2] = 21;
...
void _ui_init_g_Static_5() {
    ...
    ui_g_Static_5.option.figure_name[2] = 22;
...
void _ui_init_g_Static_6() {
    ...
    ui_g_Static_6.option.figure_name[2] = 23;
...
ui_interface_string_t* ui_g_Static_YAW_OFFSET = &(ui_g_Static_7.option);

void _ui_init_g_Static_7() {
    ui_g_Static_7.option.figure_name[0] = 0;
    ui_g_Static_7.option.figure_name[1] = 1;
    ui_g_Static_7.option.figure_name[2] = 24;
    ui_g_Static_7.option.operate_type = 1;

    ui_g_Static_YAW_OFFSET->figure_type = 7;
    ui_g_Static_YAW_OFFSET->operate_type = 1;
    ui_g_Static_YAW_OFFSET->layer = 0;
    ui_g_Static_YAW_OFFSET->color = 8;
    ui_g_Static_YAW_OFFSET->start_x = 21;
    ui_g_Static_YAW_OFFSET->start_y = 573;
    ui_g_Static_YAW_OFFSET->width = 2;
    ui_g_Static_YAW_OFFSET->font_size = 20;
    ui_g_Static_YAW_OFFSET->str_length = 4;
    strcpy(ui_g_Static_YAW_OFFSET->string, "YAW:");
...
void _ui_init_g_Static_8() {
    ...
    ui_g_Static_8.option.figure_name[2] = 25;
...
void _ui_init_g_Static_9() {
    ...
    ui_g_Static_9.option.figure_name[2] = 26;
...
void _ui_init_g_Static_10() {
    ...
    ui_g_Static_10.option.figure_name[2] = 27;
...
void _ui_init_g_Static_11() {
    ...
    ui_g_Static_11.option.figure_name[2] = 28;
...
void _ui_init_g_Static_12() {
    ...
    ui_g_Static_12.option.figure_name[2] = 29;
    ...
    ui_g_Static_Kawshiro->start_y = 335;
...
void _ui_init_g_Static_13() {
    ...
    ui_g_Static_13.option.figure_name[2] = 30;
...
void _ui_init_g_Static_14() {
    ...
    ui_g_Static_14.option.figure_name[2] = 31;
