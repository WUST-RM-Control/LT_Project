...
ui_interface_line_t *ui_default_Static_Star_1 = (ui_interface_line_t *)&(ui_default_Static_7.data[0]);
ui_interface_line_t *ui_default_Static_Star_2 = (ui_interface_line_t *)&(ui_default_Static_7.data[1]);
ui_interface_line_t *ui_default_Static_Star_3 = (ui_interface_line_t *)&(ui_default_Static_7.data[2]);
ui_interface_line_t *ui_default_Static_Star_4 = (ui_interface_line_t *)&(ui_default_Static_7.data[3]);
ui_interface_line_t *ui_default_Static_Star_5 = (ui_interface_line_t *)&(ui_default_Static_7.data[4]);
ui_interface_line_t *ui_default_Static_Star_6 = (ui_interface_line_t *)&(ui_default_Static_7.data[5]);
ui_interface_line_t *ui_default_Static_Star_7 = (ui_interface_line_t *)&(ui_default_Static_7.data[6]);
