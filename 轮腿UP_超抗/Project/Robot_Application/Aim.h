...
typedef __PACKED_STRUCT
{
    ...
    // uint32_t t_gimbal_start_mcu_us;
    uint32_t t_gimbal_ready_mcu_us;//允许发弹的时间戳
    uint32_t t_fire_cmd_apply_mcu_us;//弹丸加速完成的时间戳
} Aim_Tim_Send_StructTypedef;
/*===| 发送给电脑的数据 |===*/
typedef __PACKED_STRUCT
{
    uint8_t cmd_ID;//命令码
...
extern Aim_Tim_Send_StructTypedef Aim_Tim_Send_Struct;
