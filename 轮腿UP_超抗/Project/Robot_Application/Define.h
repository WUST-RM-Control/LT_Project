...
/*===| 云台电机通信相关定义 |===*/
    ...
    #define Gimbal_Pitch_Send_CAN_ID            0x1FF    //Pitch_CAN发送ID
...
/*===| 发射电机通信相关定义 |===*/
    #define Shoot_Fric_First_CAN                      hfdcan1    //Fric_使用的CAN
    ...
    #define Shoot_Fric_Second_CAN                      hfdcan1    //Fric_使用的CAN
    #define Shoot_Fric_Second_Send_CAN_ID              0x2FF    //Fric_CAN发送ID
    #define Shoot_Fric_Second_Right_Feedback_CAN_ID    0x205   //前右Fric_CAN反馈ID
    #define Shoot_Fric_Second_Left_Feedback_CAN_ID     0x206    //前左Fric_CAN反馈ID
    #define Shoot_Fric_Second_Middle_Feedback_CAN_ID   0x207    //前中Fric_CAN反馈ID
...
/*===| 底盘相关参数定义 |===*/
    ...
    #define Chassis_RPM_to_m_s                  (2*PI*Chassis_Wheel_Radius/60.0f/Motor_S3508_Reduction)  //底盘RPM转换成m/s的系数
...
/*===| 云台相关参数定义 |===*/  
//    #define Gimbal_Median_Yaw                  -105.292969       //云台朝前时Yaw电机的编码值
    #define Gimbal_Median_Yaw                   63.32f      //云台朝前时Yaw电机的编码值
...
/*===| 发射相关参数定义 |===*/
    #define Fric_Acc 20.0f
    #define Fric_Radius 0.03f
    #define Fric_RPM_to_m_s     (2*PI*Fric_Radius/60.0f)
    #define Trigger_Reduction (Motor_2006_Reduction * 55/23)
	#define Trigger_Bullet_Num 					 9.0f
