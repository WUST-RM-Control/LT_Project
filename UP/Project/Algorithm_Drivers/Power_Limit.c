...
{
	float Power_Per;
	Power_Per = (Motor_PID_Struct->Output * Current2Torque) * Motor_Data->Speed_RPM / 9.55f + K1 * Motor_PID_Struct->Output * Motor_PID_Struct->Output + K2 * Motor_Data->Speed_RPM * Motor_Data->Speed_RPM + Static_Power;
