...
ui_interface_arc_t *ui_default_Static_SuperCap_1 = (ui_interface_arc_t *)&(ui_default_Static_8.data[0]);
ui_interface_arc_t *ui_default_Static_SuperCap_2 = (ui_interface_arc_t *)&(ui_default_Static_8.data[1]);
ui_interface_arc_t *ui_default_Static_SuperCap_3 = (ui_interface_arc_t *)&(ui_default_Static_8.data[2]);
ui_interface_arc_t *ui_default_Static_SuperCap_4 = (ui_interface_arc_t *)&(ui_default_Static_8.data[3]);
ui_interface_arc_t *ui_default_Static_SuperCap_5 = (ui_interface_arc_t *)&(ui_default_Static_8.data[4]);
